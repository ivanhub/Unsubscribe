...
<html>
<head>
        <title>Рассылка в сфере профессионального обучения</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
        <meta name="description" content=" Email Forms">
...
<body>
		...
		<div class="wrapper rounded6" id="templateContainer">
		    <h1 class="masthead">Учебный центр "Академия"</h1>
...
<h2>Отказаться от подписки</h2>
<div>Нам жаль, что вы уходите! Введите свой адрес электронной почты, чтобы удалить себя из списка рассылки.
</div>

<form id="mc-unsubscribe-form" method="POST" action="https://samarapb.ru/unsubscribe.php#modal-one">
<!--    <input type="hidden" name="u" value="">
	...
	<br>
	<input class="button" type="submit" id="#modal-one" value="Отписаться">
...
<script>
   jQuery('#mc-unsubscribe-form').on('submit', function(e) {
 jQuery('#modal-one').show;
//e.preventDefault();
var formData = jQuery('#mc-unsubscribe-form').serializeArray();
jQuery.ajax({
        type: "POST", 
        url: "/unsubscribe/post/", 
        data: formData,
        success: function () {}
   });
...
<div class="modal" id="modal-one" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-header">
      <h2>Будем рады видеть Вас снова</h2>
      <a href="#" class="btn-close" aria-hidden="true">×</a>
    </div>
    <div class="modal-body">
      <p>E-mail удален из списка рассылки!</p>
    </div>
